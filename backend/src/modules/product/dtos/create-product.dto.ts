...
export class CreateProductDto {
  ...
  @IsNotEmpty({ message: 'GST 1 is required' })
  gst1!: boolean; // SGST
  ...
  @IsNotEmpty({ message: 'GST 2 is required' })
  gst2!: boolean; // CGST
  ...
  @IsNotEmpty({ message: 'GST 3 is required' })
  gst3!: boolean; // IGST
  ...
  @IsNotEmpty({ message: 'Product photos are required' })
  ...
  @IsNotEmpty({ message: 'Zones are required' })
  zones!: number[];
